...
const BOUNDS = {
  ...
  era: { min: 4, max: 80 },
  daily: {
    context: { min: 120, max: 1000 },
    prompt: { min: 20, max: 240 },
    reveal_quote: { min: 30, max: 600 },
    reveal_quote_attribution: { min: 5, max: 240 },
    reveal_note: { min: 120, max: 1300 },
  },
  weekly: {
    intro: { min: 200, max: 2000 },
    open_questions_each: { min: 20, max: 280 },
    closing: { min: 20, max: 320 },
    decision: { min: 100, max: 1400 },
    pullquote: { min: 20, max: 400 },
    pullquote_attribution: { min: 5, max: 240 },
    tradeoff_title: { min: 6, max: 80 },
    tradeoff_body: { min: 80, max: 700 },
    per_dim_each: { min: 60, max: 700 },
    outcome_stat: { min: 1, max: 30 },
    outcome_label: { min: 6, max: 140 },
  },
  weekly_counts: {
